...
public:
	...
	*/
	...
	/*
		@brief	Add a new record into the contents list and the event list. (to the favorite list is also possible)
	...
	*/
	...
	/*
		@brief	Get the file name from the keyboard,
				and delete that contents' record in the list.
	...
	*/
	...
	/*
		@brief	Print the details(information in masterlist) of the favorite list.
		@pre	None.
		@post	None.
	*/
	void PrintFavoriteItemsDetails();
